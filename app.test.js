...
//       account.deposit(50.00)
//       account.withdraw(25.00)
//       expect(account.showStatement()[0].date).toEqual('20/06/2023')
...
//       account.deposit(50.00)
//       account.withdraw(25.00)
//       expect(account.showStatement()[0]).toEqual({transaction: 'deposit', amount: 50.00, date: '20/06/2023', total: 50.00})
...
//       account.deposit(50.00)
//       account.withdraw(25.00)
//       expect(account.showStatement()).toEqual([{transaction: 'deposit', amount: 50.00, date: '20/06/2023', total: 50.00},{transaction: 'withdrawal', amount: 25.00, date: '20/06/2023', total:25.00}])
...
//       expect(consoleLogSpy).toHaveBeenCalledWith('20/06/2023 || ||25.00 || 25.00');
